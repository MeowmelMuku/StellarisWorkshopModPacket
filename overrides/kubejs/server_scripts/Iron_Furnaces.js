...
ServerEvents.recipes(event => {
    ...
    const furnaces = [
        ["iron_furnace", "#forge:plates/iron", "minecraft:furnace"],
        ["copper_furnace", "#forge:plates/copper", "ironfurnaces:iron_furnace"],
        ["silver_furnace", "#forge:plates/silver", "ironfurnaces:copper_furnace"],
        ["gold_furnace", "#forge:plates/gold", "ironfurnaces:silver_furnace"],
        ["diamond_furnace", "#forge:plates/diamond", "ironfurnaces:gold_furnace"],
    ];
