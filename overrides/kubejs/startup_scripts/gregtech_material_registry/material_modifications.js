...
GTCEuStartupEvents.registry("gtceu:material", event => {
	...
	//
	let zinc_ore_prop = new $OreProperty(1, 2);
	zinc_ore_prop.setOreByProducts(GTMaterials.Lead, GTMaterials.Gallium, GTMaterials.Cadmium)
	GTMaterials.Zinc.setProperty($PropertyKey.ORE, zinc_ore_prop)
