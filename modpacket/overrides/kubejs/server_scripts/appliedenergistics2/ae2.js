ServerEvents.recipes((event) => {
  ...
  event.remove({ id: "ae2:creative_energy_cell" });
  // quartz glass
  ...
  */
  ...
  event.remove({ output: "extendedae_plus:4x_crafting_accelerator" })
  greg
    .assembler("gtceu:4x_crafting_accelerator")
    .itemInputs("3x ae2:crafting_accelerator", "ae2:cell_component_4k", "#gtceu:circuits/hv")
    .itemOutputs("extendedae_plus:4x_crafting_accelerator")
    .duration(100)
    .EUt(130);

  // 16x Crafting Co-Processing Unit
  event.remove({ output: "extendedae_plus:16x_crafting_accelerator" })
  greg
    .assembler("gtceu:16x_crafting_accelerator")
    .itemInputs("3x extendedae_plus:4x_crafting_accelerator", "ae2:cell_component_16k", "#gtceu:circuits/ev")
    .itemOutputs("extendedae_plus:16x_crafting_accelerator")
    .duration(100)
    .EUt(520);

  // 64x Crafting Co-Processing Unit
  event.remove({ output: "extendedae_plus:64x_crafting_accelerator" })
  greg
    .assembler("gtceu:64x_crafting_accelerator")
    .itemInputs("3x extendedae_plus:16x_crafting_accelerator", "ae2:cell_component_64k", "#gtceu:circuits/iv")
    .itemOutputs("extendedae_plus:64x_crafting_accelerator")
    .duration(100)
    .EUt(2080);

  // 256x Crafting Co-Processing Unit
  event.remove({ output: "extendedae_plus:256x_crafting_accelerator" })
  greg
    .assembler("gtceu:256x_crafting_accelerator")
    .itemInputs("3x extendedae_plus:64x_crafting_accelerator", "ae2:cell_component_256k", "#gtceu:circuits/luv")
    .itemOutputs("extendedae_plus:256x_crafting_accelerator")
    .duration(100)
    .EUt(8320);
  ...
  */
  ...
  // Fluix Crystals
  event.remove({ output: 'ae2:fluix_crystal', type: 'create:mixing' })
  event.remove({ output: 'ae2:fluix_crystal', type: 'gtceu:mixer' })
  event.remove({ output: 'ae2:fluix_crystal', type: 'gtceu:kinetic_mixer' })
  greg
