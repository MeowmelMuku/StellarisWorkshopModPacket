...
GTCEuStartupEvents.registry("gtceu:material", event => {
	...
	event.create("bedrock")
        .ingot().fluid()
        .color(0x8E8E8E).iconSet("rough")
        .flags(
            GTMaterialFlags.GENERATE_PLATE, 
            GTMaterialFlags.GENERATE_DENSE,  // 致密材料
            GTMaterialFlags.DISABLE_DECOMPOSITION,  // 不可分解
            GTMaterialFlags.NO_SMASHING,  // 不可粉碎
            GTMaterialFlags.NO_SMELTING   // 不可熔炼
        )
        .formula("*-BedRock-*");
})
